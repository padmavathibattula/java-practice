...
public class ReplaceAllOccurencesOfSubString {
	public static ArrayList replaceSubstring(ArrayList list, String targetSubstring, String replacement) {
	...
	public static void main(String[] args) {
		...
		ArrayList output = obj.replaceSubstring(list, targetSubstring, replacement);
